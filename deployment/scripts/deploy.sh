...
cd ./PythonSyntheaFHIRClient/deployment
...
./install_python_client.sh $connection_string $polling_interval $FHIR_output_path $local_output_path $log_path $container_name
